...
# Usage:
#   ./run_runai_sdpo.sh [experiment_name_suffix]
...
EXP_NAME="RUNAI-SDPO-train${TRAIN_BATCH_SIZE}-alpha${ALPHA}-rollout${ROLLOUT_BATCH_SIZE}-lr${LR}-${MODEL_NAME}-${SUFFIX}"
JOB_NAME="sdpo-${USER}-${SUFFIX}"
...
echo "----------------------------------------------------------------"
echo "Submitting Run:AI SDPO Job"
